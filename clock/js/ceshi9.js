      ...
      flag_solar: [
        {
          ...
          flag: false,
          msg:
            '公曆2月03-05日交節立春，二十四節氣之首，是春季的第一個節氣。 立春，意味著新的一個輪迴已開啟，乃萬物起始、一切更生之義也。 立，是“開始”之意;春，代表著溫暖、生長。 立春后陽氣開始上升，日照增加，風和日暖，意味著萬物閉藏的冬季已過去，開始進入生長的季節，萬物至此漸次復甦。'
        },
        {
          name: '雨水',
          flag: false,
        ...
        },
        {
          ...
          flag: false,
          msg:
            '公曆5月20-22日交節“小滿”節氣，天氣漸漸由暖變熱，並且降水也會逐漸增多，小滿節氣意味著進入了大幅降水的雨季，雨水開始增多，往往會出現持續大範圍的強降水。 進入小滿節氣后，我國南方地區一般會降雨多、雨量大; 北方，小滿節氣期間降雨很少，氣溫上升很快，與南方的溫差進一步縮小。'
        },
        {
          name: '芒種',
          flag: false,
        ...
        },
        {
          ...
          flag: false,
          msg:
            '公曆6月21-22日交節夏至這天，太陽直射地面的位置到達一年的最北端，幾乎直射北回歸線，此時，北半球各地的白晝時間達到全年最長。 夏至是太陽的轉捩點，這天過後它將走“回頭路”，陽光直射點開始從北回歸線向南移動，北半球白晝將會逐日減短。 同時，夏至到來后，夜空星象也逐漸變成夏季星空。'
        },
        {
          name: '小暑',
          flag: false,
        ...
        },
        {
          ...
          flag: false,
          msg:
            '公曆10月08-09交節寒露是一個反映氣候變化特徵的節氣，寒露節氣后，晝漸短，夜漸長，日照減少，熱氣慢慢退去，寒氣漸生，晝夜的溫差較大，晨晚略感絲絲寒意。 古人將寒露作為寒氣漸生的表徵。 從氣候特點上看，寒露時節，南方秋意漸濃，氣爽風涼，少雨乾燥;北方廣大地區已從深秋進入或即將進入冬季。'
        },
        {
          name: '霜降',
          flag: false,
        ...
        },
        {
          ...
          flag: false,
          msg:
            '公曆1月20-21日交節大寒同小寒一樣，也是表示天氣寒冷程度的節氣。 在我國部分地區，大寒不如小寒冷，但在某些年份和沿海少數地方，全年最低汽溫仍然會出在大寒節氣內。 小寒、大寒是一年中雨水最少的時段。 大寒以後，立春接著到來，天氣漸暖。 至此地球繞太陽公轉了一周，完成了一個迴圈。'
        }
      ],
      Arrays: [],
      flag_data: [
